...
function Body:createBody()
	...
	convOutputSizes	= torch.cumprod(convOutputSizes) -- Last value is unrolled spatial output size
	RGBDnet:add(nn.View(convOutputSizes[{{convOutputDim, convOutputDim}}]):setNumInputDims(3)) --unroll
